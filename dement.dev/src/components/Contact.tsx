export const Contact = () => {
    return (
        <div id="contact" className="transition duration-500 ease-in-out dark:bg-zinc-900 bg-gray-50 flex flex-col items-start px-8 pt-2 sm:items-center py-12">
          ...
          <div className="flex flex-row items-center ml-[-1.5vw] mt-8 space-x-4 w-full max-w-prose">
            <a aria-label="linkedin profile" href="https://www.linkedin.com/in/jacob-dement-35658b275/" className="text-zinc-600 dark:text-zinc-300 hover:text-zinc-400 transition-colors">
            ...
            <a aria-label="github profile" href="https://github.com/oia20" className="text-zinc-600 dark:text-zinc-300 hover:text-zinc-400 transition-colors">
